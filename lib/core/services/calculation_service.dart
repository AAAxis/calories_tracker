...
class CalculationService {
  ...
  static Map<String, dynamic> calculateTimeline({
    ...
    // Ensure goalSpeed is not zero or too small
    final safeGoalSpeed = goalSpeed <= 0.1 ? 0.1 : goalSpeed;
    
    final weightDifference = (targetWeight - currentWeight).abs();
    final weeksToGoal = weightDifference / safeGoalSpeed;
