...
import '../wizard/5_wizard_your_age.dart';  // Import first wizard step directly
...
class _SettingsScreenState extends State<SettingsScreen> {
                  ...
                  try {
                    ...
                    if (user != null) {
                      ...
                      Navigator.pushReplacement(
                        context,
                        MaterialPageRoute(
                          builder: (context) => const WizardYourAge(),
                        ),
                      );
                    }
                  } catch (e) {
  ...
  Future<void> logout() async {
    try {
      ...
      // Navigate to onboarding flow using go_router
  ...
  void _restartWizard() {
    Navigator.push(
      context,
      MaterialPageRoute(builder: (context) => const WizardYourAge()),
    );
  }
